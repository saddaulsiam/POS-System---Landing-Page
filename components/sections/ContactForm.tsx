...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="bg-gray-50 py-20">
      ...
      >
        <div className="grid grid-cols-1 gap-0 overflow-hidden rounded-3xl bg-linear-to-br from-blue-600 to-indigo-700 shadow-sm lg:grid-cols-2">
          {/* LEFT SECTION */}
          <div className="flex flex-col justify-center p-8 text-white lg:p-12">
            ...
            <p className="mb-8 text-lg text-blue-100 sm:text-xl">
              Have questions? Need support? Want to learn more? Our team is here
              to help you anytime.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border-2 px-4 py-3 text-gray-600 placeholder-gray-400 transition-all outline-none ${
                      errors.name
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-2 border-gray-300 px-4 py-3 text-gray-600 placeholder-gray-400 transition-all outline-none focus:border-blue-500 focus:ring-blue-200"
                  />
                </div>
